...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = NSURL(string: "https://www.googleapis.com/blogger/v3/blogs/10861780/posts?key=AIzaSyAHYRlxsblZMZaQX3jcDaHqYqEfWp_B6QE")!
                ...
                do{
                    ...
                    if result.count > 0 {
                        if let items = result["items"] as? NSArray{
                            ...
                            do{
                                let cdResults = try context.executeFetchRequest(request)
                                if cdResults.count > 0 {
                                    context.deleteObject(cdResults as! NSManagedObject)
